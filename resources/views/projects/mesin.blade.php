...
<!-- Update News Start -->
 <div  class="update-news">
    <div class="text-box-news text-body-secondary font-bold">
        <h2>MECHANICAL ENGINEERING PROJECT</h2>
   ...
   @if (!$projects->isEmpty())
    ...
    <div class="card-box">
        @if ($projects->isEmpty())
            <p class="text-center mt-10 text-black py-28">There are no projects available for the Mechanical Engineering category at the moment.</p>
        @endif
